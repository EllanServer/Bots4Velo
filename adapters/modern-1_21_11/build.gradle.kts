...
tasks.shadowJar {
    archiveFileName.set("modern-1_21_11.jar")
    ...
    relocate("com.google.gson", "dev.nulli0n.vbot.adapter.v1_21_11.lib.gson")
    relocate("net.raphimc", "dev.nulli0n.vbot.adapter.v1_21_11.lib.raphimc")
    relocate("net.lenni0451", "dev.nulli0n.vbot.adapter.v1_21_11.lib.lenni0451")
    relocate("net.kyori", "dev.nulli0n.vbot.adapter.v1_21_11.lib.kyori")
    relocate("org.slf4j", "dev.nulli0n.vbot.adapter.v1_21_11.lib.slf4j")
}
